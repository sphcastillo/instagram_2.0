...
function Modal() {
    ...
    const addImageToPost = (e) => {
        ...
        // get the file that the user selected - [0] because it's only one file the user selected
        if(e.target.files[0]){
            reader.readAsDataURL(e.target.files[0]);
        }
        // once your browser it done reading the file...
        reader.onload = (readerEvent) => {
            //  we get the file in a "stateful"/ object way and we can store it in our state
